...
The Why R? Foundation will aim to provide a platform for a broad spectrum of speaker from a wide range of backgrounds, subject areas and geographic locations. We hope to schedule more R users from the Global South (i.e. Africa and Asia).

The list of invited speakers would comprise a mix of established speakers who already have are well-known in the R community, and lesser-known speakers who do not often appear in R community events. All speakers are at the same level of billing. Scheduling is influenced by speaker availability and the amount of advance notice needed by the speaker. Established speakers are able to provide talks at short notice. The capability to maintain a programe over a long term would allow us to recruit speakers who would need a lot of preparation time, particularly if it is their first talk. 
...
## Duties of the Funded Presenters
...
The Why R? Foundation will continue to use Socia media platforms (e.g. LinkedIn and Twitter) and Youtube to increase attendance to the events. The Why R? Foundation has developed a very strong social media presence in 2020.
